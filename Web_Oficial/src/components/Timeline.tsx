...
const DEFAULT_EVENTS: TimelineEvent[] = [
  {
    ...
    subtitle: "Duración: 1-3 días",
    description: `Análisis de procesos actuales, definición de objetivos/alcance, estudio de factibilidad y propuesta de soluciones.`,
  },
  {
    year: "2",
  ...
  },
  {
    ...
    subtitle: "Duración: 3-5 días",
    description: `Pruebas unitarias y de integración, validación con usuarios finales, ajustes y mejoras basadas en feedback y documentación de pruebas.`,
  },
  {
    year: "5",
    title: "Implementación",
    subtitle: "Duración: 1-2 días",
    description: `Configuración del servidor, migración de datos, configuración de SSL, optimización de rendimiento y pruebas de funcionamiento `,
  },
  {
    year: "6",
    title: "Soporte y Mantenimiento",
    subtitle: "Duración: continuo",
    description: `Monitoreo de rendimiento, actualizaciones de seguridad, nuevas funcionalidades, documentación y capacitación`,
  },
];
...
export const ScrollTimeline = ({
  ...
  subtitle = "Un enfoque metodológico y profesional para garantizar el éxito de tu proyecto tecnológico",
  ...
  return (
    ...
    >
      <div className="text-center py-8 px-4">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#fac06ee9]">
          {title}
        </h2>
        <p className="text-balance text-muted-foreground max-w-2xl mx-auto text-lg md:text-xl text-gray-200">
          {subtitle}
        </p>
      </div>
            ...
            <>
              ...
              <motion.div
                ...
                style={{
                  ...
                  background: `linear-gradient(to bottom, #f5e9c7, #f9e9a6, #f9e9a6)`,
              ...
              >
                <motion.div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle, rgba(240,247,85,0.8) 0%, rgba(241,205,99,0.5) 40%, rgba(34,211,238,0) 70%)",
                    // Intense, layered glow effect for the comet
                    boxShadow: `
                      0 0 15px 4px rgba(247, 213, 85, 0.6),
                      0 0 25px 8px rgba(241, 217, 99, 0.4),
                      0 0 40px 15px rgba(238, 200, 34, 0.2)
                    `,
                  }}
                  animate={{
                    scale: [1, 1.3, 1],
            ...
            {events.map((event, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <Card className="bg-[#ffffff57] border">
